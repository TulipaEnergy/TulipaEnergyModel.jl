...
assets_data = CSV.read(joinpath(input_dir, "asset-both.csv"), DataFrame, header = 2) # hide
graph_assets = CSV.read(joinpath(input_dir, "asset.csv"), DataFrame, header = 2) # hide
