...
Select all maximum storage-level constraint indices at representative periods with a dual equal to 0.

```@example obz
nice_query("SELECT *
    FROM cons_max_storage_level_intra_rep_period_limit
