...
Plots.plot(
    Plots.plot(timestep, thermal_no_rh - thermal_rh, title="thermal error"),
    Plots.plot(timestep, solar_no_rh - solar_rh, title="solar error"),
    Plots.plot(timestep, discharge_no_rh - discharge_rh, title="discharge error"),
