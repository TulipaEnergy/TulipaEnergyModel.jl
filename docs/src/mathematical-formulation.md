...
$p^{unit\_capacity}_{f}$               | $\mathcal{F}$      | Capacity increment for flow connections investment (both exports and imports)          | [MW]
$p^{init\_export\_capacity}_{f}$       | $\mathcal{F}$      | Initial export capacity of flow connections                                            | [MW]
$p^{init\_import\_capacity}_{f}$       | $\mathcal{F}$      | Initial import capacity of flow connections                                            | [MW]
