function _add_assets_fixed_cost_aggregated_vintage_method!(
    connection,
    model,
    expressions,
    objective_expr,
    ...
    @expression(
        model,
<<<<<<< HEAD:src/objectives/assets_fixed_cost_simple_method.jl
        assets_fixed_cost_simple_method,
=======
        assets_fixed_cost_aggregated_vintage_method,
>>>>>>> upstream/main:src/objectives/assets_fixed_cost_aggregated_vintage_method.jl
        sum(
