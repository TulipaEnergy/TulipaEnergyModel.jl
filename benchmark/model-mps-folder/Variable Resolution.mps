...
ROWS
 N  OBJ
 L  max_output_flows_limit_aggregated_vintage_method[H2,2030,1,1:6]
 ...
 L  max_output_flows_limit_aggregated_vintage_method[phs,2030,1,1:4]
 L  max_output_flows_limit_aggregated_vintage_method[phs,2030,1,5:6]
 L  max_output_flows_limit_aggregated_vintage_method[wind,2030,1,1:2]
 L  max_output_flows_limit_aggregated_vintage_method[wind,2030,1,3:3]
 L  max_output_flows_limit_aggregated_vintage_method[wind,2030,1,4:6]
 L  max_input_flows_limit_aggregated_vintage_method[phs,2030,1,1:3]
 L  max_input_flows_limit_aggregated_vintage_method[phs,2030,1,4:6]
 L  max_storage_level_intra_rep_period_limit[phs,2030,1,1:6]
 L  max_transport_flow_limit_aggregated_vintage_method[(balance,demand),2030,1,1:3]
 L  max_transport_flow_limit_aggregated_vintage_method[(balance,demand),2030,1,4:6]
 G  limit_decommission_initial_units_aggregated_vintage_method[H2,2030]
 ...
 E  consumer_balance[balance,2030,1,2:2]
 E  consumer_balance[balance,2030,1,3:3]
 E  consumer_balance[balance,2030,1,4:4]
 E  consumer_balance[balance,2030,1,5:5]
 E  consumer_balance[balance,2030,1,6:6]
...
COLUMNS
    flow[(H2,ccgt),2030,1,1:6] max_output_flows_limit_aggregated_vintage_method[H2,2030,1,1:6] 1
    flow[(H2,ccgt),2030,1,1:6] conversion_balance[ccgt,2030,1,1:6] 3
    flow[(H2,ccgt),2030,1,1:6] OBJ 0.06
    flow[(wind,balance),2030,1,1:2] max_output_flows_limit_aggregated_vintage_method[wind,2030,1,1:2] 1
    flow[(wind,balance),2030,1,1:2] consumer_balance[balance,2030,1,1:1] 1
    flow[(wind,balance),2030,1,1:2] consumer_balance[balance,2030,1,2:2] 1
    flow[(wind,balance),2030,1,1:2] OBJ 0.01
    flow[(wind,balance),2030,1,3:6] max_output_flows_limit_aggregated_vintage_method[wind,2030,1,3:3] 1
    flow[(wind,balance),2030,1,3:6] max_output_flows_limit_aggregated_vintage_method[wind,2030,1,4:6] 1
    flow[(wind,balance),2030,1,3:6] consumer_balance[balance,2030,1,3:3] 1
    flow[(wind,balance),2030,1,3:6] consumer_balance[balance,2030,1,4:4] 1
    flow[(wind,balance),2030,1,3:6] consumer_balance[balance,2030,1,5:5] 1
    flow[(wind,balance),2030,1,3:6] consumer_balance[balance,2030,1,6:6] 1
    flow[(wind,balance),2030,1,3:6] OBJ 0.02
    flow[(wind,phs),2030,1,1:3] max_output_flows_limit_aggregated_vintage_method[wind,2030,1,1:2] 1
    flow[(wind,phs),2030,1,1:3] max_output_flows_limit_aggregated_vintage_method[wind,2030,1,3:3] 1
    flow[(wind,phs),2030,1,1:3] max_input_flows_limit_aggregated_vintage_method[phs,2030,1,1:3] 1
    flow[(wind,phs),2030,1,1:3] balance_storage_rep_period[phs,2030,1,1:6] -2.7
    flow[(wind,phs),2030,1,1:3] OBJ 0.006
    flow[(wind,phs),2030,1,4:6] max_output_flows_limit_aggregated_vintage_method[wind,2030,1,4:6] 1
    flow[(wind,phs),2030,1,4:6] max_input_flows_limit_aggregated_vintage_method[phs,2030,1,4:6] 1
    flow[(wind,phs),2030,1,4:6] balance_storage_rep_period[phs,2030,1,1:6] -2.7
    flow[(wind,phs),2030,1,4:6] OBJ 0.006
    flow[(phs,balance),2030,1,1:4] max_output_flows_limit_aggregated_vintage_method[phs,2030,1,1:4] 1
    flow[(phs,balance),2030,1,1:4] consumer_balance[balance,2030,1,1:1] 1
    flow[(phs,balance),2030,1,1:4] consumer_balance[balance,2030,1,2:2] 1
    flow[(phs,balance),2030,1,1:4] consumer_balance[balance,2030,1,3:3] 1
    flow[(phs,balance),2030,1,1:4] consumer_balance[balance,2030,1,4:4] 1
    ...
    flow[(phs,balance),2030,1,5:6] max_output_flows_limit_aggregated_vintage_method[phs,2030,1,5:6] 1
    flow[(phs,balance),2030,1,5:6] consumer_balance[balance,2030,1,5:5] 1
    ...
    flow[(balance,demand),2030,1,1:3] max_transport_flow_limit_aggregated_vintage_method[(balance,demand),2030,1,1:3] 1
    flow[(balance,demand),2030,1,1:3] min_transport_flow_limit_aggregated_vintage_method[(balance,demand),2030,1,1:3] 1
    ...
    flow[(balance,demand),2030,1,4:6] max_transport_flow_limit_aggregated_vintage_method[(balance,demand),2030,1,4:6] 1
    flow[(balance,demand),2030,1,4:6] min_transport_flow_limit_aggregated_vintage_method[(balance,demand),2030,1,4:6] 1
    ...
    flow[(ccgt,balance),2030,1,1:1] max_output_flows_limit_aggregated_vintage_method[ccgt,2030,1,1:1] 1
    ...
    flow[(ccgt,balance),2030,1,2:2] max_output_flows_limit_aggregated_vintage_method[ccgt,2030,1,2:2] 1
    flow[(ccgt,balance),2030,1,2:2] consumer_balance[balance,2030,1,2:2] 1
    flow[(ccgt,balance),2030,1,2:2] conversion_balance[ccgt,2030,1,1:6] -1
    flow[(ccgt,balance),2030,1,2:2] OBJ 0.05
    flow[(ccgt,balance),2030,1,3:3] max_output_flows_limit_aggregated_vintage_method[ccgt,2030,1,3:3] 1
    flow[(ccgt,balance),2030,1,3:3] consumer_balance[balance,2030,1,3:3] 1
    flow[(ccgt,balance),2030,1,3:3] conversion_balance[ccgt,2030,1,1:6] -1
    flow[(ccgt,balance),2030,1,3:3] OBJ 0.05
    flow[(ccgt,balance),2030,1,4:4] max_output_flows_limit_aggregated_vintage_method[ccgt,2030,1,4:4] 1
    flow[(ccgt,balance),2030,1,4:4] consumer_balance[balance,2030,1,4:4] 1
    flow[(ccgt,balance),2030,1,4:4] conversion_balance[ccgt,2030,1,1:6] -1
    flow[(ccgt,balance),2030,1,4:4] OBJ 0.05
    flow[(ccgt,balance),2030,1,5:5] max_output_flows_limit_aggregated_vintage_method[ccgt,2030,1,5:5] 1
    flow[(ccgt,balance),2030,1,5:5] consumer_balance[balance,2030,1,5:5] 1
    flow[(ccgt,balance),2030,1,5:5] conversion_balance[ccgt,2030,1,1:6] -1
    flow[(ccgt,balance),2030,1,5:5] OBJ 0.05
    flow[(ccgt,balance),2030,1,6:6] max_output_flows_limit_aggregated_vintage_method[ccgt,2030,1,6:6] 1
    ...
    assets_decommission[H2,2030,2030] limit_decommission_initial_units_aggregated_vintage_method[H2,2030] -1
...
RHS
    rhs       max_output_flows_limit_aggregated_vintage_method[H2,2030,1,1:6] 400
    rhs       max_output_flows_limit_aggregated_vintage_method[ccgt,2030,1,1:1] 100
    rhs       max_output_flows_limit_aggregated_vintage_method[ccgt,2030,1,2:2] 100
    rhs       max_output_flows_limit_aggregated_vintage_method[ccgt,2030,1,3:3] 100
    rhs       max_output_flows_limit_aggregated_vintage_method[ccgt,2030,1,4:4] 100
    rhs       max_output_flows_limit_aggregated_vintage_method[ccgt,2030,1,5:5] 100
    rhs       max_output_flows_limit_aggregated_vintage_method[ccgt,2030,1,6:6] 100
    rhs       max_output_flows_limit_aggregated_vintage_method[phs,2030,1,1:4] 25
    rhs       max_output_flows_limit_aggregated_vintage_method[phs,2030,1,5:6] 25
    rhs       max_output_flows_limit_aggregated_vintage_method[wind,2030,1,1:2] 11
    rhs       max_output_flows_limit_aggregated_vintage_method[wind,2030,1,3:3] 11
    rhs       max_output_flows_limit_aggregated_vintage_method[wind,2030,1,4:6] 10.333333333333334
    rhs       max_input_flows_limit_aggregated_vintage_method[phs,2030,1,1:3] 25
    rhs       max_input_flows_limit_aggregated_vintage_method[phs,2030,1,4:6] 25
    rhs       max_storage_level_intra_rep_period_limit[phs,2030,1,1:6] 150
    rhs       max_transport_flow_limit_aggregated_vintage_method[(balance,demand),2030,1,1:3] 200
    rhs       max_transport_flow_limit_aggregated_vintage_method[(balance,demand),2030,1,4:6] 200
    rhs       limit_decommission_initial_units_aggregated_vintage_method[H2,2030] -1
    ...
    rhs       consumer_balance[balance,2030,1,2:2] 0
    rhs       consumer_balance[balance,2030,1,3:3] 0
    rhs       consumer_balance[balance,2030,1,4:4] 0
    rhs       consumer_balance[balance,2030,1,5:5] 0
    rhs       consumer_balance[balance,2030,1,6:6] 0
